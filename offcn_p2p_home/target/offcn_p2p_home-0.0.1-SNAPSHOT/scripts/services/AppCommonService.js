var option = {
    'url':{
        'api_user':'/offcn_p2p_action/user/', //用户相关
        'api_investment':'/offcn_p2p_action/investment/', 
        'api_productRate':'/offcn_p2p_action/productRate/',
        'api_product':'/offcn_p2p_action/product/', 
        'api_productAccount':'/offcn_p2p_action/productaccount/',
        'api_acount':'/offcn_p2p_action/account/',//账户信息
        'api_verification':'/offcn_p2p_action/verification/',
        'api_emailAuth':'/offcn_p2p_action/emailAuth/',
        'api_paymentpwd':'/offcn_p2p_action/paymentpwd/',
        'api_extracts':'/offcn_p2p_action/extracts/',  //提现与支付功能
        'api_bankcardInfo':'/offcn_p2p_action/bankCardInfo/',
        'api_charges':'/offcn_p2p_action/charges/'
    },
    'header':{
        'headers':{
    ...
    .factory('PostService', function($http) { 
        ...
        return {
            ...
            checkUserName:function ($str){
                ...
                //相当于$http.post('/offcn_p2p_action/user/validateUserName', $str, option.header);
            },
            //验证手机是否可用
            checkPhone:function ($str){
                return $http.post(option.url.api_user + 'validatePhone', $str, option.header);
                ///offcn_p2p_action/user/validatePhone
            },
            
         // 支付信息
            pay:function ($str){
            	alert("pay");
            return  $http.post(option.url.api_extracts+'pay',$str,option.header); 	
            }
           ,
           ...
           //注册校验验证码的正确性
            yzAuthCaptcha:function($str){
                ...
                // /offcn_p2p_action/user/codeValidate
            },
            
            //获取随机UUID
            getUuid:function(){
            	return $http.post(option.url.api_user + 'uuid','',option.header);
                // /offcn_p2p_action/user/uuid
            },
            ...
            checkAccount:function($str){
                return $http.post(option.url.api_productRate + 'checkAccount',$str, option.header);
                // /offcn_p2p_action/investment/checkAccount
            },
            
            //根据产品ID获取产品的年收益率
            getYearInterest:function($str){
                return $http.post(option.url.api_productRate+'yearInterest',$str,option.header);
                // /offcn_p2p_action/productRate/yearInterest
            },
            ...
            getAbleAccout:function(){
                ...
                // /offcn_p2p_extracts/extractMoney
            },
            ...
            withdraw:function($str){
                ...
                // /offcn_p2p_action/charges/addMayTake
            },
            ...
            updatePhone:function($str){
                return $http.post(option.url.apiuser+'addPhone', $str, option.header);
            },
